...
@Component({
  selector: 'ngx-input-flow-e2e-check-no-elements',
  template: `
        <table [(ngxInputFlow)]="persons" checkElements="None" #input="ngxInputFlow">
...
export class E2eCheckNoElementsComponent extends E2eCheckElementsComponentBase {}
